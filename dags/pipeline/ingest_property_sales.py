...
FILE_URL = config.params["PROPERTY_SALES_URL"]
FILE_NAME = config.params["PROPERTY_SALES_FILE_NAME"]
FILE_TAG = config.params["PROPERTY_SALES_FILE_TAG"]


def ingest_property_sales(**context: dict) -> None:
    """Ingest property sales zip file and extract to file store"""
